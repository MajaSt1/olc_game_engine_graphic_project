...
private:
	...
	// u¿ywamy tego czêsto - przeksza³tecnia trojk¹tów ( wierzcho³ków/wspó³rzêdnych)
	...
	// przesuwa ka¿dy wierzcho³ek o sta³¹ odleg³oœæ w okreœlonym kierunku
	...
	//To reverse a transformation, just multiply by the inverse.
	...
	// vector operation that calculates the angle between two vectors
...
public:
	...
	bool OnUserUpdate(float fElapsedTime) override
	{
		...
		for (auto tri : meshCube.tris)
		{
			...
			// Calculate triangle Normal  to determine a surface's orientation toward a light 
